...
int Gener_Arr(const int N, const int Low, const int High);
void Out_Arr(int a[6], const int N);
long Dob_Arr(int a[6], const int N);
int Sum_abs_Arr(int a[6], const int N);

const int N = 6, Low = -100, High = 100;
int a[6];
